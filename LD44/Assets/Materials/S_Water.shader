...
Shader "Custom/Water"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( sin( _Time.y ) * ase_vertexNormal ) * float3( 0.005,0.005,0.005 ) );
		}
...
/*ASEBEGIN
Version=16600
7;32;1906;987;317.9004;101.86;1.297679;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;39;263.6424,584.2786;Float;False;Property;_FoamFalloff;Foam Falloff;2;0;Create;True;0;0;False;0;0;-4.12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;64;599.5582,824.6826;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E3DEFA4D09F6AB17DD0225DCA01DB5DC9CC40D11